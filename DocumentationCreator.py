...
def MakeDocument(Title,plot,totalPoint):
    document = Document()
    ...
    document.add_picture(plot, width=Inches(8), height=Inches(6))
    ...
    table.rows[1].cells[1].text = "To Fill"
    document.save("Tryout.docx")


def ChangeOrientation(pageWidth, pageHeight):
    newWidth , newHeight = pageHeight, pageWidth
